<template>
  <div class="contact">
    <div class="contact-left">
      ...
      <div class="contact-list-title">群组 {{ groups.length }}</div>
      ...
      <div class="contact-list-title">好友 {{ friends.length }}</div>
    ...
    <div class="contact-main">
      <el-empty v-if="!profile.friend && !profile.group" description="快去开始聊天吧!"></el-empty>
